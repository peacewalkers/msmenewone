    ...
    <div class="header__top">
        <div class="ps-container">
            <div class="header__left">
                ...
                </div><a class="ps-logo" href="/"><img src="{{asset('msmelist')}}/img/images/logo-1.png" style="max-width: 55%" alt=""></a>
            </div>
            <div class="header__center">
                <form class="ps-form--quick-search" action="{{ route('page.search.do') }}" method="POST">
                    @csrf
            ...
            <div class="header__right">
                <div class="header__actions">
                    <img src="{{asset('msmelist')}}/img/images/msme-white.png" style="max-width: 20%; margin-top: 6px;">
                    <img src="{{asset('msmelist')}}/img/images/150-white.png" style="max-width: 20%; margin-top: -6px;">
        ...
        <div class="ps-container">
            ...
            <div class="navigation__right pl-0">
                ...
                <ul class="menu">
                    ...
                    @guest
                        <li >
                            <a href="{{ route('login') }}" style="left:-95px;"><i class="icon-user"></i> Login
                            </a>
                        </li>
    ...
    <div class="navigation--mobile">
        <div class="navigation__left">
            <a class="ps-logo text-center"  href="/">
                <img src="{{asset('msmelist')}}/img/images/logo-1.png" ></a></div>

    </div>
    <div class="ps-search--mobile">

        <form class="ps-form--search-mobile" action="{{ route('page.search.do') }}" method="POST">
            @csrf
...
<div class="ps-panel--sidebar" id="menu-mobile">
    ...
    <div class="ps-panel__content">
        <ul class="menu--mobile ">
            ...
            @else
                ...
                <li class="current-menu-item menu-item-has-children">
                    <a href="#"> <i class="icon-user"></i>{{ Auth::user()->name }} </a><span class="sub-toggle"></span>
        ...
        <img class="center" src="{{asset('msmelist')}}/img/banners/right.png" style="padding-top: 10px;">
    </div>
</div>
