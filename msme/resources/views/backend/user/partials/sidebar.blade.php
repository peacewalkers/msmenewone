        ...
        <li class="nav-item">
            ...
            <div id="collapse_listing" class="collapse" aria-labelledby="collapse_listing" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ route('user.items.create') }}">Post New AD</a>
                    {{--
                                    <a class="collapse-item" href="{{ route('user.items.saved') }}">My Listings</a>
                    --}}
                    <a class="collapse-item" href="{{ route('user.items.index') }}">All Listings</a>
                </div>
            </div>
        </li>
