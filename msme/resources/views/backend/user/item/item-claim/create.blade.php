...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-9">
            <h1 class="h3 mb-2 text-gray-800">{{ __('item_claim.item-claim-create-user') }}</h1>
            <p class="mb-4">{{ __('item_claim.item-claim-create-user-desc') }}</p>
        </div>
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{ route('user.item-claims.store') }}" class="" enctype="multipart/form-data">
                        @csrf
