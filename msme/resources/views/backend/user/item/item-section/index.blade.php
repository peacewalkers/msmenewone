...
@section('content')
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-3 text-right">
            <a href="{{ route('user.items.edit', ['item' => $item]) }}" class="btn btn-info btn-icon-split">
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            <div class="row mb-5">
                <div class="col-3">
                    @if(empty($item->item_image))
                        <img id="image_preview" src="{{ asset('frontend/images/placeholder/full_item_feature_image.webp') }}" class="img-responsive rounded">
                    @else
                ...
                <div class="col-9">
                    ...
                    <p>{{ $item->item_address_hide == 0 ? $item->item_address . ', ' : '' }} {{ $item->city->city_name . ', ' . $item->state->state_name . ' ' . $item->item_postal_code }}</p>
                    <hr/>
            ...
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{ route('user.items.sections.store', ['item' => $item]) }}">
                        @csrf
                ...
                @foreach($item_sections_after_breadcrumb as $item_sections_after_breadcrumb_key => $after_breadcrumb_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_sections_after_breadcrumb_key%2 == 0 ? 'bg-light' : '' }} {{ $after_breadcrumb_section->item_section_status == \App\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            ...
                            @endif
                            |
                            <a class="ml-1" href="{{ route('user.items.sections.edit', ['item' => $item, 'item_section' => $after_breadcrumb_section->id]) }}">
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-12">
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.up', ['item' => $item, 'item_section' => $after_breadcrumb_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                            ...
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.down', ['item' => $item, 'item_section' => $after_breadcrumb_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('user.items.sections.destroy', ['item' => $item, 'item_section' => $after_breadcrumb_section->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                ...
                @foreach($item_section_after_gallery as $item_section_after_gallery_key => $after_gallery_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_gallery_key%2 == 0 ? 'bg-light' : '' }} {{ $after_gallery_section->item_section_status == \App\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            ...
                            @endif
                            |
                            <a class="ml-1" href="{{ route('user.items.sections.edit', ['item' => $item, 'item_section' => $after_gallery_section->id]) }}">
                                <i class="fas fa-edit"></i>
                                {{ __('item_section.edit-section-link') }}
                            </a>
                            <ul>
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-12">
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.up', ['item' => $item, 'item_section' => $after_gallery_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-up"></i>
                            ...
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.down', ['item' => $item, 'item_section' => $after_gallery_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-down"></i>
                    ...
                    <div class="modal fade" id="item_section_delete_{{ $after_gallery_section->id }}" tabindex="-1" role="dialog" aria-labelledby="item_section_delete_{{ $after_gallery_section->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                                    <form action="{{ route('user.items.sections.destroy', ['item' => $item, 'item_section' => $after_gallery_section->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">{{ __('backend.shared.delete') }}</button>
                                    </form>
                ...
                @foreach($item_section_after_description as $item_section_after_description_key => $after_description_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_description_key%2 == 0 ? 'bg-light' : '' }} {{ $after_description_section->item_section_status == \App\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            ...
                            @endif
                            |
                            <a class="ml-1" href="{{ route('user.items.sections.edit', ['item' => $item, 'item_section' => $after_description_section->id]) }}">
                                <i class="fas fa-edit"></i>
                                {{ __('item_section.edit-section-link') }}
                            </a>
                            <ul>
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-12">
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.up', ['item' => $item, 'item_section' => $after_description_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-up"></i>
                            ...
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.down', ['item' => $item, 'item_section' => $after_description_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-down"></i>
                    ...
                    <div class="modal fade" id="item_section_delete_{{ $after_description_section->id }}" tabindex="-1" role="dialog" aria-labelledby="item_section_delete_{{ $after_description_section->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                                    <form action="{{ route('user.items.sections.destroy', ['item' => $item, 'item_section' => $after_description_section->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">{{ __('backend.shared.delete') }}</button>
                                    </form>
                ...
                @foreach($item_section_after_location_map as $item_section_after_location_map_key => $after_location_map_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_location_map_key%2 == 0 ? 'bg-light' : '' }} {{ $after_location_map_section->item_section_status == \App\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            ...
                            @endif
                            |
                            <a class="ml-1" href="{{ route('user.items.sections.edit', ['item' => $item, 'item_section' => $after_location_map_section->id]) }}">
                                <i class="fas fa-edit"></i>
                                {{ __('item_section.edit-section-link') }}
                            </a>
                            <ul>
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-12">
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.up', ['item' => $item, 'item_section' => $after_location_map_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-up"></i>
                            ...
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.down', ['item' => $item, 'item_section' => $after_location_map_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-down"></i>
                    ...
                    <div class="modal fade" id="item_section_delete_{{ $after_location_map_section->id }}" tabindex="-1" role="dialog" aria-labelledby="item_section_delete_{{ $after_location_map_section->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                                    <form action="{{ route('user.items.sections.destroy', ['item' => $item, 'item_section' => $after_location_map_section->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">{{ __('backend.shared.delete') }}</button>
                                    </form>
                ...
                @foreach($item_section_after_features as $item_section_after_features_key => $after_features_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_features_key%2 == 0 ? 'bg-light' : '' }} {{ $after_features_section->item_section_status == \App\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            ...
                            @endif
                            |
                            <a class="ml-1" href="{{ route('user.items.sections.edit', ['item' => $item, 'item_section' => $after_features_section->id]) }}">
                                <i class="fas fa-edit"></i>
                                {{ __('item_section.edit-section-link') }}
                            </a>
                            <ul>
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-12">
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.up', ['item' => $item, 'item_section' => $after_features_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-up"></i>
                            ...
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.down', ['item' => $item, 'item_section' => $after_features_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-down"></i>
                    ...
                    <div class="modal fade" id="item_section_delete_{{ $after_features_section->id }}" tabindex="-1" role="dialog" aria-labelledby="item_section_delete_{{ $after_features_section->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                                    <form action="{{ route('user.items.sections.destroy', ['item' => $item, 'item_section' => $after_features_section->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">{{ __('backend.shared.delete') }}</button>
                                    </form>
                ...
                @foreach($item_section_after_reviews as $item_section_after_reviews_key => $after_reviews_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_reviews_key%2 == 0 ? 'bg-light' : '' }} {{ $after_reviews_section->item_section_status == \App\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            ...
                            @endif
                            |
                            <a class="ml-1" href="{{ route('user.items.sections.edit', ['item' => $item, 'item_section' => $after_reviews_section->id]) }}">
                                <i class="fas fa-edit"></i>
                                {{ __('item_section.edit-section-link') }}
                            </a>
                            <ul>
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-12">
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.up', ['item' => $item, 'item_section' => $after_reviews_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-up"></i>
                            ...
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.down', ['item' => $item, 'item_section' => $after_reviews_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-down"></i>
                    ...
                    <div class="modal fade" id="item_section_delete_{{ $after_reviews_section->id }}" tabindex="-1" role="dialog" aria-labelledby="item_section_delete_{{ $after_reviews_section->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                                    <form action="{{ route('user.items.sections.destroy', ['item' => $item, 'item_section' => $after_reviews_section->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">{{ __('backend.shared.delete') }}</button>
                                    </form>
                ...
                @foreach($item_section_after_comments as $item_section_after_comments_key => $after_comments_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_comments_key%2 == 0 ? 'bg-light' : '' }} {{ $after_comments_section->item_section_status == \App\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            ...
                            @endif
                            |
                            <a class="ml-1" href="{{ route('user.items.sections.edit', ['item' => $item, 'item_section' => $after_comments_section->id]) }}">
                                <i class="fas fa-edit"></i>
                                {{ __('item_section.edit-section-link') }}
                            </a>
                            <ul>
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-12">
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.up', ['item' => $item, 'item_section' => $after_comments_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-up"></i>
                            ...
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.down', ['item' => $item, 'item_section' => $after_comments_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-down"></i>
                    ...
                    <div class="modal fade" id="item_section_delete_{{ $after_comments_section->id }}" tabindex="-1" role="dialog" aria-labelledby="item_section_delete_{{ $after_comments_section->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                                    <form action="{{ route('user.items.sections.destroy', ['item' => $item, 'item_section' => $after_comments_section->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">{{ __('backend.shared.delete') }}</button>
                                    </form>
                ...
                @foreach($item_section_after_share as $item_section_after_share_key => $after_share_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_share_key%2 == 0 ? 'bg-light' : '' }} {{ $after_share_section->item_section_status == \App\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            ...
                            @endif
                            |
                            <a class="ml-1" href="{{ route('user.items.sections.edit', ['item' => $item, 'item_section' => $after_share_section->id]) }}">
                                <i class="fas fa-edit"></i>
                                {{ __('item_section.edit-section-link') }}
                            </a>
                            <ul>
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-12">
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.up', ['item' => $item, 'item_section' => $after_share_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-up"></i>
                            ...
                            <form class="float-left pr-1" action="{{ route('user.items.sections.rank.down', ['item' => $item, 'item_section' => $after_share_section->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-primary btn-sm text-white">
                                    <i class="fas fa-arrow-down"></i>
                    ...
                    <div class="modal fade" id="item_section_delete_{{ $after_share_section->id }}" tabindex="-1" role="dialog" aria-labelledby="item_section_delete_{{ $after_share_section->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                                    <form action="{{ route('user.items.sections.destroy', ['item' => $item, 'item_section' => $after_share_section->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">{{ __('backend.shared.delete') }}</button>
                                    </form>
