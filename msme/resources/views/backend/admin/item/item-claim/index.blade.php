...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-9">
            <h1 class="h3 mb-2 text-gray-800">{{ __('item_claim.item-claim-admin') }}</h1>
            <p class="mb-4">{{ __('item_claim.item-claim-admin-desc') }}</p>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <div class="row mb-2">
                        <div class="col-12">
                            <form class="form-inline" action="{{ route('admin.item-claims.index') }}" method="GET">
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            @foreach($all_item_claims as $key => $item_claim)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.users.edit', ['user' => $item_claim->user->id]) }}">
