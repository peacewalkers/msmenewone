                    ...
                    <form method="POST" action="{{ route('admin.plans.store') }}" class="">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input id="plan_max_featured_listing" type="text" class="form-control @error('plan_max_featured_listing') is-invalid @enderror" name="plan_max_featured_listing" value="{{ old('plan_max_featured_listing') }}">
