...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-9">
            <h1 class="h3 mb-2 text-gray-800">{{ __('products.create') }}</h1>
            <p class="mb-4">{{ __('products.create-desc') }}</p>
        </div>
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <form method="POST" action="{{ route('admin.products.store') }}" class="">
                        @csrf
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('product_description') is-invalid @enderror" id="product_description" rows="5" name="product_description">{{ old('product_description') }}</textarea>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="custom-select" name="product_status">
                                    <option value="{{ \App\Product::STATUS_PENDING }}" {{ old('product_status') == \App\Product::STATUS_PENDING ? 'selected' : '' }}>{{ __('products.product-status-pending') }}</option>
                                    <option value="{{ \App\Product::STATUS_APPROVED }}" {{ old('product_status') == \App\Product::STATUS_APPROVED ? 'selected' : '' }}>{{ __('products.product-status-approved') }}</option>
                                    <option value="{{ \App\Product::STATUS_SUSPEND }}" {{ old('product_status') == \App\Product::STATUS_SUSPEND ? 'selected' : '' }}>{{ __('products.product-status-suspend') }}</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                <label for="user_id" class="text-black">{{ __('products.form-product-owner') }}</label>
                                ...
                                <small class="form-text text-muted">
                                    {{ __('products.form-product-owner-help') }}
                                </small>
                                @error('user_id')
                                <span class="invalid-tooltip">
                                    <strong>{{ $message }}</strong>
