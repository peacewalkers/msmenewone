            ...
            <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        @if(!empty($find_product_after_breadcrumb->product_price))
                                                                            <span class="text-black">{{ $site_global_settings->setting_product_currency_symbol . $find_product_after_breadcrumb->product_price }}</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        @if(!empty($find_product_after_gallery->product_price))
                                                                            <span class="text-black">{{ $site_global_settings->setting_product_currency_symbol . $find_product_after_gallery->product_price }}</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        @if(!empty($find_product_after_description->product_price))
                                                                            <span class="text-black">{{ $site_global_settings->setting_product_currency_symbol . $find_product_after_description->product_price }}</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        @if(!empty($find_product_after_location_map->product_price))
                                                                            <span class="text-black">{{ $site_global_settings->setting_product_currency_symbol . $find_product_after_location_map->product_price }}</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        @if(!empty($find_product_after_features->product_price))
                                                                            <span class="text-black">{{ $site_global_settings->setting_product_currency_symbol . $find_product_after_features->product_price }}</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        @if(!empty($find_product_after_reviews->product_price))
                                                                            <span class="text-black">{{ $site_global_settings->setting_product_currency_symbol . $find_product_after_reviews->product_price }}</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        @if(!empty($find_product_after_comments->product_price))
                                                                            <span class="text-black">{{ $site_global_settings->setting_product_currency_symbol . $find_product_after_comments->product_price }}</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        @if(!empty($find_product_after_share->product_price))
                                                                            <span class="text-black">{{ $site_global_settings->setting_product_currency_symbol . $find_product_after_share->product_price }}</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                ...
                <div class="col-lg-3 ml-auto">
                    ...
                    <div class="pt-3">
                        ...
                        @if(!Auth::check() || (Auth::check() && Auth::user()->id != $item->user_id))
                        <div class="row mb-2 align-items-center">
                            <div class="col-12">
                                <h3 class="h5 text-black">{{ __('rating_summary.contact') }}</h3>
                            </div>
                        </div>
                        @endif
                    ...
                    <div class="d-block d-md-flex listing">
                        ...
                        <div class="lh-content">
                            ...
                            @if($similar_item->getCountRating() > 0)
                                <div class="row">
                                    <div class="col-12">
                                        <div class="pl-0 rating_stars rating_stars_{{ $similar_item->item_slug }}" data-id="rating_stars_{{ $similar_item->item_slug }}" data-rating="{{ $similar_item->getAverageRating() }}"></div>
                                        <address class="mt-1">
                        ...
                        <div class="d-block d-md-flex listing">
                            ...
                            <div class="lh-content">
                                ...
                                @if($nearby_item->getCountRating() > 0)
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="pl-0 rating_stars rating_stars_{{ $nearby_item->item_slug }}" data-id="rating_stars_{{ $nearby_item->item_slug }}" data-rating="{{ $nearby_item->getAverageRating() }}"></div>
                                            <address class="mt-1">
