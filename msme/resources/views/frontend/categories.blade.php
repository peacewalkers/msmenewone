                    ...
                    @foreach( $categories as $key => $category )
                            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
                                <a href="{{ route('page.category', $category->category_slug) }}" class="popular-category h-100">
                                    ...
                                    <span class="number">{{ number_format($category->getItemsCount($site_global_settings->setting_site_location_country_id)) }}</span>
                                </a>
                            </div>
                    @endforeach
                    </div>
                        ...
                        <div class="col-md-12">
                            <form method="GET" action="{{ route('page.categories') }}">
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label for="filter_categories" class="text-black">{{ __('listings_filter.categories') }}</label>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label class="text-black" for="filter_sort_by">{{ __('listings_filter.sort-by') }}</label>
