                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8">
                            ...
                            @if(!empty($product->product_price))
                                <span>{{ $site_global_settings->setting_product_currency_symbol . $product->product_price }}</span>
                                <hr>
                            @endif
                            ...
                            @if(Auth::check())
                                @if(Auth::user()->id != $item->user_id)
                                    @if(Auth::user()->isAdmin())
                                        <a href="{{ route('admin.messages.create', ['item' => $item->id]) }}" class="btn btn-primary text-white rounded">{{ __('item_section.contact-listing-owner') }}</a>
                                    @else
                                        <a href="{{ route('user.messages.create', ['item' => $item->id]) }}" class="btn btn-primary text-white rounded">{{ __('item_section.contact-listing-owner') }}</a>
                                    @endif
                                @endif
                            @else
                                <a href="{{ route('user.messages.create', ['item' => $item->id]) }}" class="btn btn-primary text-white rounded">{{ __('item_section.contact-listing-owner') }}</a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div id="product-image-gallery">
                                @foreach($product->productGalleries as $product_galleries_key => $product_gallery)
