    ...
    <div class="ps-layout__right">
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <label>1. Applicant Name / आवेदक का नाम (Required) *
                                            <span id="some-div">
                                                <img src="{{asset('msmelist')}}/img/info.svg"
                                        ...
                                        <input class="form-control" type="text" placeholder="Please enter your name...">
                                            ...
                                            <div class="form-group">
                                                    <label>2. Mobile Number / मोबाइल संख्या (Required) *
                                                        <span id="some-div">
                                                            <img src="{{asset('msmelist')}}/img/info.svg" width="20"
                                                                  data-toggle="tooltip"
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label>21. Turnover (per annum) / टर्नओवर (प्रति वर्ष)
                                                        <span id="some-div">
                                                            <img src="{{asset('msmelist')}}/img/info.svg" width="20"  data-toggle="tooltip" data-placement="right" data-trigger="hover" title="">
                                                          </span>
                                                    </label>
                                                    <input id="plantaddress" class="form-control plantaddress" type="number" placeholder="Please enter Plant Location Address" >
                                                </div>
        ...
        <div id="btns">
            <div class="btn" onclick="window.location='#'">
                 <img src="{{asset('msmelist')}}/img/form.svg" width="65">
                <h3>1. Submit Application</h3>
            </div>
            <div class="btn" onclick="window.location='#'">
                <img src="{{asset('msmelist')}}/img/payment.svg" width="65">

                <h3>2. Make Payment</h3>
            </div>
            <div class="btn" onclick="window.location='#'">
                <img src="{{asset('msmelist')}}/img/upload.svg" width="65">

                <h3>3. Processes Application</h3>
            </div>
            <div class="btn" onclick="window.location='#'">
                <img src="{{asset('msmelist')}}/img/certificate.svg" width="65">
