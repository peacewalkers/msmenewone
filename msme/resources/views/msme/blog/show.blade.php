                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-8 text-center">
                            ...
                            @if($data['post']->topic()->get()->count() != 0)
                                <p class="mb-0" style="color: {{ $site_innerpage_header_paragraph_font_color }};">{{ $data['post']->topic()->get()->first()->name }}</p>
                            @else
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    @endif
                        ...
                        <div class="row post-body mb-3">
                            <div class="col-12">
                                {!! clean($data['post']->body, array('HTML.Allowed' => 'div[style],b[style],strong[style],i[style],em[style],u[style],a[href|title],ul[style],ol[style],li[style],p[style],br,span[style],img[width|height|alt|src|style],h1[style],h2[style],h3[style],h4[style],h5[style],h6[style]')) !!}
                            </div>
                        </div>
                ...
                <div class="col-md-3 ml-auto">
                    ...
                    @include('frontendok.blog.partials.sidebar')
