        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8">
                            ...
                            <?php if(!empty($product->product_price)): ?>
                                <span><?php echo e($site_global_settings->setting_product_currency_symbol . $product->product_price); ?></span>
                                <hr>
                            <?php endif; ?>
                            ...
                            <?php if(Auth::check()): ?>
                                <?php if(Auth::user()->id != $item->user_id): ?>
                                    <?php if(Auth::user()->isAdmin()): ?>
                                        <a href="<?php echo e(route('admin.messages.create', ['item' => $item->id])); ?>" class="btn btn-primary text-white rounded"><?php echo e(__('item_section.contact-listing-owner')); ?></a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('user.messages.create', ['item' => $item->id])); ?>" class="btn btn-primary text-white rounded"><?php echo e(__('item_section.contact-listing-owner')); ?></a>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php else: ?>
                                <a href="<?php echo e(route('user.messages.create', ['item' => $item->id])); ?>" class="btn btn-primary text-white rounded"><?php echo e(__('item_section.contact-listing-owner')); ?></a>
                    ...
                    <?php if(count($product->productGalleries) > 0): ?>
                    <hr>
                    <div class="row">
                        <div class="col-12">
                            <div id="product-image-gallery">
                                <?php $__currentLoopData = $product->productGalleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_galleries_key => $product_gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\msmenewone\msme\resources\views/frontend/product.blade.php ENDPATH**/ ?>