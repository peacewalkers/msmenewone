...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapse_product" class="collapse" aria-labelledby="collapse_product" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.product.setting.edit')); ?>"><?php echo e(__('products.sidebar.setting')); ?></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse_customization" aria-expanded="true" aria-controls="collapse_customization">
            ...
            <span><?php echo e(__('customization.customization')); ?></span>
        </a>
        <div id="collapse_customization" class="collapse" aria-labelledby="collapse_customization" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('admin.customization.color.edit')); ?>"><?php echo e(__('customization.color')); ?></a>
                <a class="collapse-item" href="<?php echo e(route('admin.customization.header.edit')); ?>"><?php echo e(__('customization.header')); ?></a>
            </div>
        </div>
    </li>
...
<!-- End of Sidebar -->
<?php /**PATH C:\laragon\www\msmenewone\laravel_project\resources\views/backend/admin/partials/sidebar.blade.php ENDPATH**/ ?>