...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12">
                                <label class="text-black" for="categorytype_id">Business Type</label>
                                <select class="custom-select <?php $__errorArgs = ['categorytype_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="categorytype_id" id="categorytype_id">
                                    <option value="1">Services</option>
                                    <option value="2">Supply</option>
                                </select>
                                <?php $__errorArgs = ['categorytype_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" name="category_parent_id">
                                    ...
                                    <?php $__currentLoopData = $printable_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $printable_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($printable_category["category_id"]); ?>"><?php echo e($printable_category["category_name"]); ?></option>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\msmenewone\msme\resources\views/backend/admin/category/create.blade.php ENDPATH**/ ?>