...
class Item extends Model implements ReviewRateable
{
    ...
    const ITEM_LISTING_SERVICE = 'services';
    const ITEM_LISTING_PRODUCTS = 'supply';
    ...
    const ITEM_TOTAL_SHOW_CATEGORY_HOME = 1;
    ...
    const ITEMS_SORT_BY_NEWEST = 1;
    const ITEMS_SORT_BY_OLDEST = 2;
    const ITEMS_SORT_BY_HIGHEST = 3;
    const ITEMS_SORT_BY_LOWEST = 4;
    ...
    protected $searchable = [
        ...
        'columns' => [
            ...
            'items.item_description' => 8,
            'items.item_features_string' => 7,
    ...
    public function getClaimedUser()
    {
        if($this->hasClaimed())
        {
            ...
            return $item_claim->user()->get()->first();
        }
        else
        {
            return null;
