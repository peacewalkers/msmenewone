...
class Setting extends Model
{
    ...
    protected $fillable = [
        ...
        'settings_site_smtp_username', 'settings_site_smtp_password', 'setting_site_language_source',
        'setting_site_razorpay_enable', 'setting_site_razorpay_api_key', 'setting_site_razorpay_api_secret',
        ...
        'setting_site_map', 'setting_site_map_google_api_key',
    ];
}
