...
class ItemController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        else
        {
            ...
            {
                $items_query = Item::where('user_id', $login_user->id)
                    ->where('country_id', $settings->setting_site_location_country_id)
                    ->orderBy('created_at', 'DESC');
            }
        }
    ...
    public function create(Request $request)
    {
        ...
        $countries = DB::table('categorytypes')->pluck("name","id");
...
/*        if(count($category_ids) > 0)
        ...
        return response()->view('backend.user.item.create',
            compact('all_categories', 'all_states', 'countries', 'setting_site_location_lat', 'setting_site_location_lng'));
    }
...
//        $item_status = $request->item_status;
    ...
    public function edit(Item $item)
    {
        ...
        return response()->view('backend.user.item.edit',
            compact('all_states', 'all_cities', 'item', 'categories',
